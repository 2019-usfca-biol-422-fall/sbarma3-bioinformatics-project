...
To gather my results for my culture-free samples, I analyzed the sequence qualties by running FastQC reports. I, then, cleaned and trimmed my sequences using Trimmomatic. Once again, my samples were run through the BLAST tool to identify the bacterial strain and later determine the amount of varying taxa within each of my samples. I was also able to determine the most commonly occuring taxa and genera, as well as the number of sequences present. 
