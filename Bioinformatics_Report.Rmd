...
### DADA 
I used the DADA pipeline to count the total amount of Amplicon Sequence Variants, count the number of chimeras present, determine taxonomy for each sample, and remove any extra sequences. 
...
and *Staphylococcus epidermis* (Table 1). *Kocuria palustris* is a bacteria that 
