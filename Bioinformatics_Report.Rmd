...
**Table 7:** Table shows the culture-free BLAST results
...
**Table 7:** Table shows the abundance of the top Phylum for each sample group including controls
...
melted_phyloseq %>%
  ...
  ggtitle("Abundance of Taxa")
```

**Figure 8:** Bar plot shows the abundance of each taxa per sample group and both controls
...
melted_phyloseq %>%
  ...
  ggtitle("Strain Diversity of *Streptococcus*")
```
