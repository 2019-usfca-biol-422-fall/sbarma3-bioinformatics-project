...
After extraction, samples were diluted to 1x, 10x, and 100x using PBS solution, 
and then cultured. I used 18 100 mm TSA plates for plating samples from each of
my 2 treatments (n = 3 per group, 6 total). Then, I pipetted 100 μL of each 
...
One round was with a PCR done with cultured samples and the second round was 
done with culture free samples. 
